...
common::utils::Circuit<Ring> generateCircuit(size_t gates_per_level, size_t depth) {
    ...
    for (size_t d = 0; d < depth; ++d) {
        ...
        level_outputs[0] = circ.addGate(common::utils::GateType::kAdd, level_outputs[0], level_outputs[1]);
        level_outputs[1] = circ.addGate(common::utils::GateType::kAdd, level_outputs[2], level_outputs[3]);
        level_outputs[4] = circ.addGate(common::utils::GateType::kAdd, level_outputs[1], level_outputs[3]);
        level_outputs[2] = circ.addGate(common::utils::GateType::kAdd, level_inputs[0], level_inputs[1]);
        ...
        */
        ...
        if (pid > 0) {
            ...
            for (size_t l = 0; l < depth; l++) {
                Ring einp1 = expected[0];
                Ring einp2 = expected[1];
                ...
                expected[4] = expected[1] + expected[3];
                expected[2] = einp1 + einp2;
            }
